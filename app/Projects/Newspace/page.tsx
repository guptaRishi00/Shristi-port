...
export default function NewspacePortfolio() {
  ...
  return (
    ...
    >
      ...
      <section className="relative w-full min-h-[70vh]">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 pt-24 sm:pt-32 flex flex-col">
          ...
          <p className="text-gray-400 text-sm sm:text-lg max-w-2xl leading-relaxed">
            (Due to NDA restrictions, I cannot share detailed visuals of this
            work.
            <br />
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-start">
            <p className="text-gray-300 leading-relaxed mb-6">
              At Newspace Research & Technologies, I designed mission-critical
              interfaces for aerospace and defence applications. In these
              high-stakes environments, design had to be more than aesthetic —
              it had to deliver clarity, speed, and reliability.
            </p>
            <p className="text-gray-300 leading-relaxed">
              My focus was on creating systems that empowered users to make
              confident decisions in complex operational contexts.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white/10 border border-gray-500 rounded-lg p-10 max-w-lg mx-auto h-full">
            <p className="text-gray-200 leading-relaxed">
              ...
              mission-critical environments where interfaces needed to be clear,
              reliable, and efficient. The challenge was to simplify complex
              data systems while ensuring accuracy, usability, and trust for
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white">
                  Led a comprehensive website redesign that improved usability
                  and boosted engagement by 30%.
                </p>
              </div>
            </div>
          </div>
          <div className="p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white">
                  Designed interactive data visualization dashboards, helping
                  teams interpret complex information quickly and accurately.
                </p>
              </div>
            </div>
          </div>
          <div className="p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white">
                  Built component-based design systems, ensuring consistency and
                  reducing design-to-development time by 15%.
                </p>
              </div>
            </div>
          </div>
          <div className="p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white">
                  Created accessible dark-mode patterns optimized for long
                  operational hours and mission environments.
                </p>
              </div>
            </div>
          </div>
          <div className="p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white">
                  Partnered with engineers, product managers, and domain experts
                  to align designs with real-world requirements.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                {
                  title: "UI Redesign",
                  text: "Improved usability, leading to a 30% increase in user engagement",
                },
                {
                  title: "Mission Dashboards",
                  text: "Designed interactive visualizations for real-time decision-making",
                },
                {
                  title: "Dark-Mode UI",
                  text: "Crafted accessible dark-mode layouts optimized for long operational shifts",
                },
                {
                  title: "Design Systems",
                  text: "Introduced component libraries that reduced design-to-development time by 15%",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="border border-white bg-white/10 rounded-lg p-6"
                >
      ...
      {/* Impact & Results */}
      <section className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-16 mb-16">
        <h2 className="text-4xl font-bold mb-12 text-center">
          Impact & Results
        </h2>
          ...
          {[
            {
              ...
              text: "Through Streamlined Workflows And Intuitive Layouts",
            },
            {
              num: "30%",
              title: "User Engagement Boost",
              text: "Delivered User-Centered Design Solutions That Balanced Precision With Usability",
            },
            {
              num: "15%",
              title: "Faster Development",
              text: "Strengthened Design Culture By Introducing Scalable Systems And Establishing Design Principles",
            },
          ].map((item, i) => (
            <div
              key={i}
              className="border border-white rounded-lg p-8 text-center"
            >
